...
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400&display=swap" rel="stylesheet">
   ...
   <?php
    ...
    if (isset($_GET['submit'])) {
        ...
        if($_GET['section_id']!=$cat_no){
        header("location:test1.php?section_id=".$next_id);
        }
...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="test1.php?section_id=" .<?php $my_section_id ?> method="GET">
                    ...
                    while($rowQ = mysqli_fetch_assoc($gg))
                        {
                            ...
                            if (mysqli_num_rows($radioQ) > 0) {
                                ...
                                while ($rowRadio = mysqli_fetch_array($radioQ)) {
                                    ...
                                    echo '<td id='.$rowRadio['id'].' style="text-align:center;margin:auto"><input type="radio" value="' . $rowRadio['id'] . '" name="' . $rowQ['quiz_id'] . '" id='.$rowRadio['id'].'></td>';    
