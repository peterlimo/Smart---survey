...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="survey.php?section_id=" .<?php $my_section_id ?> method="GET">
            ...
            while($row = mysqli_fetch_array($qq))
            {
                ...
                echo '<div class=""><h5 style="color:#202124;font-weight: 400;font-family:"Google Sans",Roboto,Arial,sans-serif">'.$row['group_title'].'</h5></div>';
                }
