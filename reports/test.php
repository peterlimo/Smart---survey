        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
            ...
            ';
                    ...
                    while ($row = mysqli_fetch_assoc($gg)) {
                        ...
                        } else if ($row['type'] == "location" && $row['group_type'] == "NA") {
                            $countySql = "select * from counties";
                            $countyQuery = mysqli_query($conn, $countySql);
                            while ($countyRows = mysqli_fetch_assoc($countyQuery)) {
                                $county = "select * from answers where answer= " . $countyRows['id'] . "";
                                $conty = mysqli_query($conn, $county);
                                $total = mysqli_num_rows($conty);
                                echo '<div>';
